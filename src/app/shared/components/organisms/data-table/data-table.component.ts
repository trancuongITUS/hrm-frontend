...
import { TableColumn, PaginationConfig, SortConfig, SelectionMode, TableAction } from '@shared/models';
            ...
            <ng-template pTemplate="header" let-columns>
                <tr>
                    ...
                    @for (col of columns; track col.field) {
                        <th [pSortableColumn]="col.sortable ? col.field : null" [style.width]="col.width" [class]="'text-' + (col.align || 'left')">
...
export class DataTableComponent<T = unknown> {
    ...
    visibleActions(rowData: T): TableAction<T>[] {
        return this.actions().filter((action) => !action.visible || action.visible(rowData));
    }
